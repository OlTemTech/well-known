<?php
	...
	class Model{
		...
		public static $dbName="dharehx_mon"; //Database Name
		public static $username="dharehx_mon"; // Database Username
		public static $password="dharehx_mon"; //Database Password

        public static $dbh;
        
		public $emailUsername="support@jossyfeydataservice.com.ng"; //Support Email Address
		public $emailPassword="Emmanuel@76"; //Support Email Password
