        ...
        <div class="card card-style">
            <div class="content ">
                ...
                <div class="text-center">
                    <div class="pb-5 pt-5">
                        <img src="../../assets/img/logodark.png?v=1.1" class="img-fluid" width="250" />
                    </div>
                ...
                <div class="px-2">
                    ...
                    <div class="row pt-5 mb-3">
                        ...
                        <div class="col-12 text-center font-15 mt-3">
                            <a class="text-dark" href="https://topupmate.com/welcome/"><b>JOSSYFEYDATA/b></a>
                        </div>
                    </div>
...
$("document").ready(function(){
    ...
    function checkIfPhoneNumberSaved() {
        ...
        if($phone != null && $phone != ""){
            let msg='<p class="mb-3"><a href="javascript:showNumber();"><b class="text-dark">Login With Another Account?</b></a></p>';
