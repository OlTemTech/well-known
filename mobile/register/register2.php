...
<style>
    ...
    .card{background: rgba(255,255,255,0.9); margin:20px;}
    ...
    <div class="card card-style" style="min-width:450px; padding:20px;">
            <div class="content">
                ...
                <div class="text-center">
                    ...
                    <h1 class="font-30 mb-3">Register</h1>
                ...
                <div class="px-2">
                    ...
                    <div class="row pt-3 mb-3">
                        <div class="col-12 text-center font-15 mt-2">
                            <a class="text-dark" href="../login/">Already Have An Account, <b>Login Now</b></a>
                        </div>
                    </div>

                    <div class="col-12 text-center font-15 mt-3">
                        <a class="text-dark" href="https://topupmate.com/welcome/"><b>Licensed By Topupmate Technology LTD</b></a>
                    </div>
